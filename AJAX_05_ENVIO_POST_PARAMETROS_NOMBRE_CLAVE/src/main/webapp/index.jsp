    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function f_configurarNegociador() {
                ...
                negociador.onreadystatechange = function() {
                    ...
                    if (negociador.readyState === 4 && negociador.status === 200) {
                        ...
                        document.getElementById("verCodigoSecreto").innerHTML = respuesta;
                    }
            ...
            function f_conectarNavegadorServidor(nombre,clave) {
                ...
                negociador.send("nombre="+nombre+"&"+"clave="+clave); // UNA CADENA DE TEXTO SIN EL ?.
            ...
            function f_comprobarCampos() {
                ...
                var valorClave = document.getElementById("clave").value.trim();

                if(valorNombre == "" || valorClave == "") {
                    alert("ERROR, DEBES INTRODUCIR NOMBRE Y CLAVE");
                    return;
                }
                
                // LANZAR EL PROCESO AJAX.
                f_crearNegociador(valorNombre, valorClave);
            }   
                ...
                <tr style="background-color:greenyellow">            
                    <td>
                        ...
                        <input type="text" id="nombre" value="" size="20" 
                        		maxlength="15" style="color:blue;"
                        		autofocus/>
                    </td>
                    
                    <td>
                        CLAVE:
                        <input type="password" id="clave" value="" size="20" 
                        		maxlength="15" style="color:red;"/>
                    </td>                
                </tr>

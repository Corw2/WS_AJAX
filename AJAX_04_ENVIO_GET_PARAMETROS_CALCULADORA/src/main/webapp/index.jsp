...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function f_calcular() {
                ...
                var x = document.getElementById("cajaX").value.trim(); // 3 
                var y = document.getElementById("cajaY").value.trim(); // 2               
    ...
    <body>
        ...
        <div align="center">
            ...
            <!-- 4 columnas de ancho -->
            <table style="background-color:silver; border:3px solid blue;">
                
                <tr style="background-color:orange">
                    <td colspan="2">
                        <!-- RECORDAR QUE COLOCAMOS LOS PARÁMETROS DIRECTAMENTE EN LA URL DE AJAX PORQUE USAMOS GET -->
                        X: <input type="text" id="cajaX" value="" size="3" maxlength="3" style="color:red;" autofocus/>
                    </td>
                    <td colspan="2">
